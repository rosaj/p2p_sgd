...
def filtered_clients(client_num, examples_range, ret_val='clients'):
    train_clients, val_clients, test_clients = load_client_datasets(client_num)
    return filter_clients(train_clients, val_clients, test_clients, client_num, examples_range, ret_val)
