...
class DataProcessor(object):
    ...
    def label_len(self):
        # get label from subclass, but subtract all additional tokens, other than 0 (one)
        return len(self.get_labels()) - max(len(self.initial_tokens)-1, 0)
...
class FewNERDProcessor(DataProcessor):
    ...
    def get_labels(self):
        return super(FewNERDProcessor, self).get_labels() + ["I-LOC", "I-ORG", "I-PER", "I-MISC", "I-PRO", "I-ART",
                                                             "I-BUI", "I-EVE"]
